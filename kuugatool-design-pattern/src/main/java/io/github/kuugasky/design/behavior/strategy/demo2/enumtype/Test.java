...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("HighPrice:" + RankEnum.valueOf("HighPrice").sort(list).stream().map(Stock::getCode).collect(Collectors.joining(",")));
        System.out.println("LowPrice:" + RankEnum.valueOf("LowPrice").sort(list).stream().map(Stock::getCode).collect(Collectors.joining(",")));
        System.out.println("HighRise:" + RankEnum.valueOf("HighRise").sort(list).stream().map(Stock::getCode).collect(Collectors.joining(",")));
    }
