...
class RSAUtilTest {
    ...
    void getKey() throws Exception {
        ...
        Key Key1 = RSAKeyPairUtil.getPublicKeyFromString("");
    ...
    void getPrivateKey() throws Exception {
        ...
        PrivateKey Key1 = RSAKeyPairUtil.getPrivateKeyFromString("");
        // System.out.println(Base64.getEncoder().encodeToString(Key.getEncoded()));
        System.out.println(Base64.getEncoder().encodeToString(Key1.getEncoded()));
    }
    ...
    void encrypt() throws Exception {
        RSAKeyPairUtil.RSAKeyPair rsaKeyPair = RSAKeyPairUtil.initRsaKeyPair("kuugasky");
        System.out.println("rsa密钥对:" + JSON.toJSONString(rsaKeyPair));

        PublicKey key = rsaKeyPair.getRsaPublicKey();
    ...
    void encrypt2() throws Exception {
        ...
        PublicKey publicKey = rsaKeyPair.getRsaPublicKey();
    ...
    void decrypt() throws Exception {
        ...
        RSAPublicKey publicKey = rsaKeyPair.getRsaPublicKey();
        RSAPrivateKey privateKey = rsaKeyPair.getRsaPrivateKey();

        String plaintext = "https://www.baidu.com?search=万里长城，锦绣中华";
        plaintext = UrlCodeUtil.encode(plaintext);
        ...
        Console.redLog("plaintext = " + decrypt);
        Console.redLog("plaintext2 = " + UrlCodeUtil.decode(decrypt));
    }
    ...
    void decryptByKey() throws Exception {
        ...
        String publicKeyBase64Str = rsaKeyPair.getRsaPublicKeyBase64Str();
        String privateKeyStr = rsaKeyPair.getRsaPrivateKeyBase64Str();
        ...
        // 甲方进行数据的加密
        PublicKey publicKey = RSAKeyPairUtil.getPublicKeyFromString(publicKeyBase64Str);
        PrivateKey privateKey = RSAKeyPairUtil.getPrivateKeyFromString(privateKeyStr);
    ...
    void encryptSegmented() throws Exception {
        RSAKeyPairUtil.RSAKeyPair rsaKeyPair = RSAKeyPairUtil.initRsaKeyPair();
        String encryptSegmented = RSAUtil.encryptSegmented("万里长城，锦绣中华", rsaKeyPair.getRsaPublicKey());
        System.out.println(encryptSegmented);

        String decryptSegmented = RSAUtil.decryptSegmented(encryptSegmented, rsaKeyPair.getRsaPrivateKey());
    ...
    void sbw() throws Exception {
        ...
        System.out.println("publicKey:" + rsaKeyPair.getRsaPublicKeyBase64Str());
        System.out.println("privateKey:" + rsaKeyPair.getRsaPrivateKeyBase64Str());
