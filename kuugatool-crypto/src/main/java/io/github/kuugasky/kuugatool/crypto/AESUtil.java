...
public final class AESUtil {
     ...
     * @return 密文
     */
    public static String encrypt(String encodeRules, String message) throws Exception {
     ...
     * @return String
     */
    public static String decrypt(String encodeRules, String encryptStr) throws Exception {
        // 根据encodeRules规则初始化密钥生成器
        initKeyGenerator(encodeRules);
        // 产生原始对称密钥
        SecretKey originalKey = keygen.generateKey();
