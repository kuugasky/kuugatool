...
import io.github.kuugasky.kuugatool.extra.coordinate.entity.LngLat;
...
public final class CoordinateTransformUtil {
    ...
    public static void main(String[] args) {
        LngLat map = convertMC2LL(Double.parseDouble("12686154.35"), Double.parseDouble("2560680.16"));
        System.out.println("百度坐标：" + map);
        double lng = map.getLongitude();
        double lat = map.getLatitude();
        LngLat longitudeBd = new LngLat(lng, lat);
        System.out.println("高德坐标：" + bdDecrypt(longitudeBd));
    }
