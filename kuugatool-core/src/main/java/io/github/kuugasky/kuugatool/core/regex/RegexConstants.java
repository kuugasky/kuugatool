...
public interface RegexConstants {
    ...
    /**
     * 正则：yyyy-MM-dd HH:mm:ss格式的日期校验，已考虑平闰年
     */
    String REGEX_DATE_TIME = "^((([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))-02-29))\\s+([0-1]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$";
    /**
     * 正则：IP地址
     */
    ...
    String REGEX_IMAGE_URL = "(https://|http://)?([\\w-]+\\.)+[\\w-]+(:\\d+)*(/[\\w-./?%&=]*)?[\\u4E00-\\u9FFF]*[\\w-]+.[\\w]+";
