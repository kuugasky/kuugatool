...
public enum BasicType {
     ...
     */
    public static final Map<Class<?>, Class<?>> WRAPPER_PRIMITIVE_MAP = new ConcurrentHashMap<>(9);

    /**
     * 原始类型为Key，包装类型为Value，例如： int.class => Integer.class
     */
    public static final Map<Class<?>, Class<?>> PRIMITIVE_WRAPPER_MAP = new ConcurrentHashMap<>(9);
