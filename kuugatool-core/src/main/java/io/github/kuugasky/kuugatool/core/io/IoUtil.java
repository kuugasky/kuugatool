...
public class IoUtil extends NioUtil {
    ...
    /**
     * 拷贝文件流
     * 直接调用inputStream的transferTo()方法，将输入流中数据直接复制刷写到输出流中
     *
     * @param in  输入
     * @param out 输出
     * @throws IORuntimeException IO异常
     */
    public static void copyTransferTo(FileInputStream in, FileOutputStream out) throws IORuntimeException {
        Assert.notNull(in, "FileInputStream is null!");
        Assert.notNull(out, "FileOutputStream is null!");
    ...
    public static BufferedReader getUtf8Reader(InputStream in) {
        return getReader(in, Charset.defaultCharset());
    }
    ...
    public static OutputStreamWriter getUtf8Writer(OutputStream out) {
        return getWriter(out, Charset.defaultCharset());
    }
    ...
    public static String read(InputStream in, String charsetName) throws IORuntimeException {
        ...
        try {
            return new String(result.getBytes(charsetName));
     ...
     * @return byte数组
     */
    public static byte[] readBytes(BufferedImage bImage, String format) {
    ...
    public static <T extends Collection<String>> T readUtf8Lines(InputStream in, T collection) throws IORuntimeException {
        return readLines(in, Charset.defaultCharset(), collection);
    }
    ...
    public static void readUtf8Lines(InputStream in, LineHandler lineHandler) throws IORuntimeException {
        readLines(in, Charset.defaultCharset(), lineHandler);
    }
     ...
     * @return 字节流
     */
    public static ByteArrayInputStream toInputStream(String content, String charsetName) {
        return toInputStream(content, Charset.forName(charsetName));
    }
     ...
     * @return 字节流
     */
    public static ByteArrayInputStream toInputStream(String content, Charset charset) {
        if (content == null) {
            return null;
        }
        return toInputStream(content.getBytes(charset));
    }
    ...
    public static ByteArrayInputStream toUtf8Stream(String content) {
        return toInputStream(content, Charset.defaultCharset());
    }
     ...
     * 网络url文件转换成输入流
     *
     * @param fileUrl 网络url文件
     * @return 输入流
     * @throws IOException IOException
     */
    public static InputStream toInputStream(String fileUrl) throws IOException {
     ...
     */
    public static FileOutputStream toOutputStream(File file) {
        try {
     ...
     */
    public static ZipOutputStream toZipOutputStream(File file) {
        return new ZipOutputStream(toOutputStream(file));
    }
    ...
    public static void writeUtf8(OutputStream out, boolean isCloseOut, Object... contents) throws IORuntimeException {
        write(out, Charset.defaultCharset(), isCloseOut, contents);
    }
     ...
     * @since 4.3.2
     */
    public static void closeIfPossibly(Object obj) {
    ...
    public static byte[] fileUrlToBytes(String fileUrl) throws IOException {
        return SslTrust.fileUrlToBytes(fileUrl);
    }
