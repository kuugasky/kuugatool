package io.github.kuugasky.kuugatool.core.math;
...
public class Calculator {
    ...
    private static String transform(String expression) {
        expression = StringUtil.removeAllSpace(expression);
        expression = StringUtil.removeEnd(expression, "=");
    ...
    private BigDecimal calculate(String firstValue, String secondValue, char currentOp) {
        return switch (currentOp) {
            case '+' -> BigDecimalUtil.add(firstValue, secondValue);
            case '-' -> BigDecimalUtil.subtract(firstValue, secondValue);
            case '*' -> BigDecimalUtil.multiply(firstValue, secondValue);
            case '/' -> BigDecimalUtil.divide(firstValue, secondValue);
