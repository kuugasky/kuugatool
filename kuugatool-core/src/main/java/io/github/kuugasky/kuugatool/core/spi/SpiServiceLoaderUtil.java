...
import io.github.kuugasky.kuugatool.core.clazz.ClassLoaderUtil;
 ...
 *     3、文件内容填写实现类的全限定类名
 * </pre>
 * <a href="https://www.jianshu.com/p/3a3edbcd8f24">相关介绍</a>
 *
 * @author looly
 * @since 5.1.6
 */
public class SpiServiceLoaderUtil {
    ...
    /**
     * 从JRT ServiceLoader服务加载中，使用类加载读取该class对应的ServiceLoad
     *
     * @param <T>   接口类型
     * @param clazz 服务接口
     * @return 服务接口实现列表
    ...
    /**
     * 从JRT ServiceLoader服务加载中，使用指定类加载读取该class对应的ServiceLoad
     *
     * @param <T>    接口类型
     * @param clazz  服务接口
     * @param loader {@link ClassLoader}
     * @return 服务接口实现列表(服务加载器)
     */
