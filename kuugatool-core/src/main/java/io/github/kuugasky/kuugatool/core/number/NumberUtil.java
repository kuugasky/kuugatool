...
import io.github.kuugasky.kuugatool.core.collection.IterUtil;
...
public final class NumberUtil {
     ...
     * @return boolean
     */
    public static boolean isPositiveInteger(Object str) {
    ...
    public static BigDecimal getNumber(String str) {
        try {
            String number = str.replaceAll(StringUtil.ZERO_NINE_REGEX, StringUtil.EMPTY);
            if (StringUtil.isEmpty(number)) {
                return BigDecimal.ZERO;
            }
            return new BigDecimal(number);
        } catch (Exception e) {
            logger.error("not a valid integer value:{}", e.getMessage());
            return null;
        }
    }
     ...
     *
     * @param str         str
     * @param toNumerical 将提取出来的数字转数值（数值类型会移除掉最前面掉0）
     * @return str
     */
    public static String getNumberStr(String str, boolean toNumerical) {
        try {
            String number = str.replaceAll(StringUtil.ZERO_NINE_REGEX, StringUtil.EMPTY);
            if (!toNumerical) {
                return number;
     ...
     * @return List
     */
    public static List<Integer> parseIntList(CharSequence obj, String separator) {
        List<Integer> list = ListUtil.newArrayList();
        if (StringUtil.hasText(obj)) {
            String[] temp = StringUtil.trim(obj).split(separator);
            for (String str : temp) {
                Integer i = NumberParseUtil.parseInt(str);
                list.add(i);
            }
        }
        return list;
     ...
     * @return List
     */
    public static List<Integer> parseIntList(CharSequence obj) {
     ...
     * @return Integer[]
     */
    public static Integer[] parseIntArray(CharSequence obj, String separator) {
        return parseIntList(obj, separator).toArray(new Integer[0]);
    }
     ...
     * @return Integer[]
     */
    public static Integer[] parseIntArray(CharSequence obj) {
     ...
     * @return List
     */
    public static List<Long> parseLongList(CharSequence obj, String separator) {
        List<Long> list = ListUtil.newArrayList();
        if (StringUtil.hasText(obj)) {
            String[] temp = StringUtil.trim(obj).split(separator);
            for (String str : temp) {
                Long l = NumberParseUtil.parseLong(str);
                list.add(l);
            }
        }
        return list;
     ...
     * @return List
     */
    public static List<Long> parseLongList(CharSequence obj) {
     ...
     * @return Long
     */
    public static Long[] parseLongArray(CharSequence obj, String separator) {
        return parseLongList(obj, separator).toArray(new Long[0]);
    }
     ...
     * @return String
     */
    public static String parseScienceNumber(Object obj) {
     ...
     * @return Float
     */
    public static Integer getInt(Integer val, Integer defaultVal) {
        if (null == val) {
            return defaultVal;
        }
        return val;
     ...
     * @return Float
     */
    public static Float getFloat(Float val, Float defaultVal) {
        if (null == val) {
            return defaultVal;
        }
        return val;
     ...
     * @return Double
     */
    public static Double getDouble(Double val, Double defaultVal) {
        if (null == val) {
            return defaultVal;
        }
        return val;
     ...
     * @return BigDecimal
     */
    public static BigDecimal getBigDecimal(BigDecimal val, BigDecimal defaultVal) {
        if (null == val) {
            return defaultVal;
        }
        return val;
     ...
     * @return Long[]
     */
    public static Long[] parseLongArray(CharSequence obj) {
     ...
     * @return Double
     */
    public static Double formatVal(Double val) {
        Double resultVal;
        if (null == val) {
            resultVal = null;
        } else {
            resultVal = new BigDecimal(Double.toString(val)).setScale(2, RoundingMode.HALF_UP).doubleValue();
        }
        return resultVal;
    }
     ...
     * @return boolean
     */
    public static boolean judgeErrorRange(double value1, double value2) {
        return Math.abs(new BigDecimal(value1).subtract(new BigDecimal(value2)).doubleValue()) > 0.1;
    }
     ...
     * @since 5.1.6
     */
    public static <T extends Number> String decimalFormat(String pattern, T value) {
    ...
    public static int[] generateRandomNumber(int begin, int end, int size) {
        // 种子你可以随意生成，但不能重复
        final int[] seed = range(true, false, begin, end, 1);
        return generateRandomNumber(seed, size);
    }
     ...
     * @since 5.4.5
     */
    public static int[] generateRandomNumber(int[] seed, int size) {
    ...
    /**
     * 【开区间】从0开始给定范围内的整数列表，步进为1
     *
     * @param stop 结束（包含）
     * @return 整数列表
     * @since 3.3.1
     */
    public static int[] rangeOpenInterval(int stop) {
        return rangeOpenInterval(0, stop);
    }
     ...
     * @return 整数列表
     */
    public static int[] rangeOpenInterval(int start, int stop) {
        return rangeOpenInterval(start, stop, 1);
    }
     ...
     * @return 整数列表
     */
    public static int[] rangeOpenInterval(int start, int stop, int step) {
        return range(true, true, start, stop, step);
    }

    /**
     * 【闭区间】从0开始给定范围内的整数列表，步进为1
     *
     * @param stop 结束（不包含）
     * @return 整数列表
     * @since 3.3.1
     */
    public static int[] rangeClosedInterval(int stop) {
        return rangeClosedInterval(0, stop);
    }
     ...
     * @return 整数列表
     */
    public static int[] rangeClosedInterval(int start, int stop) {
        return rangeClosedInterval(start, stop, 1);
    }
     ...
     * @return 整数列表
     */
    public static int[] rangeClosedInterval(int start, int stop, int step) {
        return range(false, false, start, stop, step);
    }

    /**
     * 自定义给定范围区间内的整数列表
     *
     * @param leftOpenInterval  左边是否开区间
     * @param rightOpenInterval 右边是否开区间
     * @param start             开始
     * @param stop              结束
     * @param step              步进(两个数值元素的间隔值)
     * @return 整数列表
     */
    public static int[] range(boolean leftOpenInterval, boolean rightOpenInterval, int start, int stop, int step) {
        if (!leftOpenInterval) {
            start += 1;
        }
        if (!rightOpenInterval) {
            stop -= 1;
        }
        if (start < stop) {
            step = Math.abs(step);
     ...
     * 最小公倍数
     * 最小公倍數是數論中的一個概念。
     * 若有一個數X，可以被另外兩個數A、B整除，且X大於（或等於）A和B，則X為A和B的公倍數
     *
     * @param m 第一个值
     * @param n 第二个值
     * @return 最小公倍数
    ...
    public static BigDecimal toBigDecimal(String number) {
        ...
        return StringUtil.isEmpty(number) ? BigDecimal.ZERO : new BigDecimal(number);
    }
    ...
    public static BigInteger toBigInteger(String number) {
        return toBigInteger(parseNumber(number));
    }
    ...
    public static int parseInt(String number) throws NumberFormatException {
        ...
        if (StringUtil.startsWithIgnoreCase(number, "0x")) {
            // 0x04表示16进制数
     ...
     * @return 补零String
     */
    public static String zeroPaddingOfFront(int value, int expectedLength) {
        return zeroPaddingOfFront(String.valueOf(value), expectedLength);
    }

    public static String zeroPaddingOfFront(long value, int expectedLength) {
        return zeroPaddingOfFront(String.valueOf(value), expectedLength);
    }

    private static String zeroPaddingOfFront(String value, int expectedLength) {
        if (StringUtil.isEmpty(value)) {
            throw new RuntimeException("value cannot be null or empty.");
        }
        int length = value.length();
        if (length < expectedLength) {
            StringBuffer buffer = StringUtil.buffer();
            buffer.append(StringUtil.repeat("0", (expectedLength - length)));
            buffer.append(value);
     ...
     */
    public static Number moneyStrToNumber(String moneyStr) throws ParseException {
        if (StringUtil.isEmpty(moneyStr)) {
            return null;
        }
        moneyStr = moneyStr.replaceAll(KuugaConstants.COMMA, KuugaConstants.COMMAENG);
        DecimalFormatSymbols dfs = new DecimalFormatSymbols();
        dfs.setDecimalSeparator(KuugaConstants.POINT.charAt(0));
        dfs.setGroupingSeparator(KuugaConstants.COMMAENG.charAt(0));
        dfs.setMonetaryDecimalSeparator(KuugaConstants.COMMAENG.charAt(0));
        DecimalFormat df = new DecimalFormat("###,###,###,###.##", dfs);
        return df.parse(moneyStr);
    }

    // stream reduce ================================================================================================================================================

    public static <T extends Number> T sum(Iterable<T> iterable) {
        List<T> objects = IterUtil.toList(iterable);
        if (ListUtil.isEmpty(objects)) {
            return null;
        }
        T t = objects.get(0);
        if (t instanceof Integer) {
            IntStream intStream = objects.stream().mapToInt(ObjectUtil::cast);
            return ObjectUtil.cast(intStream.sum());
        } else if (t instanceof Long) {
            LongStream longStream = objects.stream().mapToLong(ObjectUtil::cast);
            return ObjectUtil.cast(longStream.sum());
        } else if (t instanceof Double) {
            DoubleStream doubleStream = objects.stream().mapToDouble(ObjectUtil::cast);
            return ObjectUtil.cast(doubleStream.sum());
        } else {
            return sum(objects);
        }
    }
    ...
    public static <T extends Number> T max(Set<T> set) {
        return max(ListUtil.newArrayList(set));
    }
    ...
    public static <T extends Number> T max(List<T> list) {
        list = ListUtil.optimize(list, true);
        if (ListUtil.isEmpty(list)) {
            return null;
        }
        T one = list.get(0);
        if (one instanceof Integer) {
            return (T) ((List<Integer>) list).stream().min(Comparator.reverseOrder()).get();
        } else if (one instanceof Long) {
            return (T) ((List<Long>) list).stream().min(Comparator.reverseOrder()).get();
        } else if (one instanceof Float) {
            return (T) ((List<Float>) list).stream().min(Comparator.reverseOrder()).get();
        } else if (one instanceof Short) {
            return (T) ((List<Short>) list).stream().min(Comparator.reverseOrder()).get();
        } else if (one instanceof Double) {
            return (T) ((List<Double>) list).stream().min(Comparator.reverseOrder()).get();
        } else if (one instanceof BigDecimal) {
            return (T) ((List<BigDecimal>) list).stream().min(Comparator.reverseOrder()).get();
        }
        return null;
    }
    ...
    public static <T extends Number> T min(Set<T> set) {
        return min(ListUtil.newArrayList(set));
    }
    ...
    public static <T extends Number> T min(List<T> list) {
        ...
        T one = list.get(0);
        if (one instanceof Integer) {
            return (T) ((List<Integer>) list).stream().min(Comparable::compareTo).get();
        } else if (one instanceof Long) {
            return (T) ((List<Long>) list).stream().min(Comparable::compareTo).get();
        } else if (one instanceof Short) {
            return (T) ((List<Short>) list).stream().min(Comparable::compareTo).get();
        } else if (one instanceof Float) {
            return (T) ((List<Float>) list).stream().min(Comparable::compareTo).get();
        } else if (one instanceof Double) {
            return (T) ((List<Double>) list).stream().min(Comparable::compareTo).get();
        } else if (one instanceof BigDecimal) {
            return (T) ((List<BigDecimal>) list).stream().min(Comparable::compareTo).get();
        }
        return null;
    }
    ...
    public static long sum(final long... ints) {
        return Arrays.stream(ints).sum();
    }

    public static double sum(final double... ints) {
        return Arrays.stream(ints).sum();
    }

    public static BigDecimal sum(final BigDecimal... bigDecimals) {
        return sum(ListUtil.newArrayList(bigDecimals));
    }

    public static <E extends Number> E sum(final Set<E> set) {
        return sum(ListUtil.newArrayList(set));
    }
     ...
     * @return 综合
     */
    public static <E extends Number> E sum(final List<E> list) {
        if (ListUtil.isEmpty(list)) {
            return null;
        }
        E first = ListUtil.findFirst(list);

        if (first instanceof Integer) {
            int sum = list.stream().filter(StringUtil::hasText).mapToInt(E::intValue).sum();
            return ObjectUtil.cast(sum);
        }
        if (first instanceof Double) {
            double sum = list.stream().filter(StringUtil::hasText).mapToDouble(E::doubleValue).sum();
            return ObjectUtil.cast(sum);
        }
        if (first instanceof Float) {
            Float sum = list.stream().filter(StringUtil::hasText).map((E s) -> Float.parseFloat(String.valueOf(s))).reduce(Float::sum).orElse(null);
            return ObjectUtil.cast(sum);
        }
        if (first instanceof Long) {
            long sum = list.stream().filter(StringUtil::hasText).mapToLong(E::longValue).sum();
            return ObjectUtil.cast(sum);
        }
        if (first instanceof Short) {
            Integer sum = list.stream().filter(StringUtil::hasText).mapToInt(E::intValue).sum();
            return ObjectUtil.cast(sum);
        }
        if (first instanceof BigDecimal) {
            BigDecimal sum = list.stream().filter(StringUtil::hasText).map((E s) -> new BigDecimal(String.valueOf(s))).reduce(BigDecimal.ZERO, BigDecimal::add);
            return ObjectUtil.cast(sum);
        }
        return null;
    }
    ...
    public static Integer averagingInt(final List<Integer> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.averagingInt(x -> x)).intValue();
    }

    public static long averagingLong(final List<Long> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.averagingLong(x -> x)).longValue();
    }

    public static double averagingDouble(final List<Double> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.averagingDouble(x -> x));
    }

    // summarizing 汇总 ============================================================================================================

    public static IntSummaryStatistics summarizingInt(final List<Integer> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.summarizingInt(x -> x));
    }

    public static LongSummaryStatistics summarizingLong(final List<Long> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.summarizingLong(x -> x));
    }

    public static DoubleSummaryStatistics summarizingDouble(final List<Double> list) {
        return ListUtil.optimize(list, true).stream().collect(Collectors.summarizingDouble(x -> x));
    }
