...
import io.github.kuugasky.kuugatool.core.convert.Convert;
...
public class ConsoleTable {
    ...
    private static final char LF = KuugaCharConstants.LF;
    ...
    private void fillBorder(StringBuilder sb) {
        ...
        for (Integer width : columnCharNumber) {
            sb.append(Convert.toSBC(StringUtil.repeatAndJoin(ROW_LINE, width + 2, StringUtil.EMPTY)));
            sb.append(CORNER);
        }
        sb.append(LF);
    }
