...
import io.github.kuugasky.kuugatool.core.lang.func.Func0;
...
public final class Singleton {
    ...
    public static <T> T get(Class<T> clazz, Object... params) {
        ...
        if (ArrayUtil.isEmpty(params)) {
            return get(key, () -> ReflectionUtil.newInstance(clazz));
        }
        return get(key, () -> ReflectionUtil.newInstance(clazz, params));
    }
    ...
    private static String buildKey(String className, Object... params) {
        ...
        return StringUtil.format("{}#{}", className, StringJoinerUtil.join("_", params));
    }
    // ------------------------------------------------------------------------------------------- Private method end
}
