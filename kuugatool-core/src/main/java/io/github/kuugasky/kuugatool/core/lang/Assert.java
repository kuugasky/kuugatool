...
public class Assert {
     ...
     * @since 5.4.5
     */
    public static <T extends CharSequence, X extends Throwable> T notEmpty(T object, Supplier<X> errorSupplier) throws X {
        if (object instanceof String) {
            if (StringUtil.isEmpty(object)) {
                throw errorSupplier.get();
            }
        } else if (object instanceof Collection) {
            if (CollectionUtil.isEmpty((Collection<?>) object)) {
                throw errorSupplier.get();
            }
        }
        return object;
     ...
     * @return 被检查的子串
     * @throws X 非子串抛出异常
     * @see StringUtil#contains(String, String)
     * @since 5.4.5
     */
