...
public class HexUtil {
    ...
    public static boolean isHexNumber(String value) {
        ...
        String zeroXbyLower = "0x";
        String zeroXbyUpper = "0X";
        String well = "#";
        if (value.startsWith(zeroXbyLower, index) || value.startsWith(zeroXbyUpper, index) || value.startsWith(well, index)) {
            try {
    ...
    public static byte[] decodeHex(String hexStr) {
        ...
        hexStr = StringUtil.trim(hexStr).replaceAll("\\s", StringUtil.EMPTY);
    ...
    public static String toUnicodeHex(int value) {
        ...
        int len = hex.length();
        if (len < KuugaConstants.FOUR) {
            String fourZero = "0000";
            // 不足4位补0
            builder.append(fourZero, 0, 4 - len);
        }
        builder.append(hex);
    ...
    public static String format(String hexStr) {
        ...
        for (int i = 2; i < length - 1; i += 2) {
            builder.append(KuugaCharConstants.SPACE).append(hexStr.charAt(i)).append(hexStr.charAt(i + 1));
        }
        return builder.toString();
    }
