...
import io.github.kuugasky.kuugatool.core.io.watch.watchers.WatcherChain;
    ...
    public void init() throws WatchException {
        ...
        if (!Files.exists(this.path, LinkOption.NOFOLLOW_LINKS)) {
            ...
            if (null != lastPathEle) {
                ...
                if (StringUtil.contains(lastPathEleStr, ".") && !StringUtil.endsWithIgnoreCase(lastPathEleStr, ".d")) {
