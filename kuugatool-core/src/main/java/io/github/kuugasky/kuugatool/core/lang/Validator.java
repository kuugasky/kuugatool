...
import io.github.kuugasky.kuugatool.core.idcard.IDCardUtil;
...
public class Validator {
    ...
    public static boolean isEmpty(Object value) {
        return (null == value || (value instanceof String && StringUtil.isEmpty(value)));
    }
    ...
    public static boolean isMatchRegex(Pattern pattern, CharSequence value) {
        return RegexUtil.isMatch(pattern.pattern(), value);
    }
    ...
    public static boolean hasChinese(CharSequence value) {
        return RegexUtil.contains(PatternPool.RE_CHINESE_MORE, value);
    }
