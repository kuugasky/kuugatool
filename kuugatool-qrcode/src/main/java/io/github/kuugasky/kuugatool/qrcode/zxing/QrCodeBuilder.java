package io.github.kuugasky.kuugatool.qrcode.zxing;
...
public class QrCodeBuilder {
     ...
     */
    static {
        QrCodeBuilder.embeddedImgDefaultWidth = 80;
        QrCodeBuilder.embeddedImgDefaultHeight = 80;
        QrCodeBuilder.frameWidth = 0;
        QrCodeBuilder.frameWidthColor = Color.BLUE.getRGB();
        QrCodeBuilder.qrCodeColor = Color.BLACK.getRGB();
        QrCodeBuilder.qrCodeBackgroundColor = Color.WHITE.getRGB();
        QrCodeBuilder.fillColor = Color.RED.getRGB();
    }
    ...
    public static void modifyBasicParamsValues(Integer embeddedImgDefaultWidth, Integer embeddedImgDefaultHeight,
        ...
        if (embeddedImgDefaultWidth != null) {
            QrCodeBuilder.embeddedImgDefaultWidth = embeddedImgDefaultWidth;
        }
        if (embeddedImgDefaultHeight != null) {
            QrCodeBuilder.embeddedImgDefaultHeight = embeddedImgDefaultHeight;
        }
        if (frameWidth != null) {
            QrCodeBuilder.frameWidth = frameWidth;
        }
        if (frameWidthColor != null) {
            QrCodeBuilder.frameWidthColor = frameWidthColor.getRGB();
        }
        if (qrCodeColor != null) {
            QrCodeBuilder.qrCodeColor = qrCodeColor.getRGB();
        }
        if (qrCodeBackgroundColor != null) {
            QrCodeBuilder.qrCodeBackgroundColor = qrCodeBackgroundColor.getRGB();
        }
        if (fillColor != null) {
            QrCodeBuilder.fillColor = fillColor.getRGB();
        }
    }
    ...
    public static String encodeQrCodeWithEmbeddedImg(String content, int width, int height, File embeddedImgFile,
        ...
        boolean result = ImageIO.write(genBufferedImageWithEmbeddedImg(content, width, height, embeddedImgFile), "jpg",
    ...
    public static void encodeQrCodeWithEmbeddedImg(String content, int width, int height, File embeddedImgFile,
        ...
        boolean result = ImageIO.write(genBufferedImageWithEmbeddedImg(content, width, height, embeddedImgFile), "jpg", outputStream);
    ...
    public static BufferedImage encodeQrCodeWithEmbeddedImgAndFontsForBufferedImage(QrImage param) throws IOException, WriterException {
        ...
        File embeddedImgFileFile = param.getEmbeddedImgFile();
        ...
        if (embeddedImgFileFile == null) {
            qrImage = genBufferedImage(qrCodeContent, qrCodeWidth, qrCodeHeight);
        } else {
            qrImage = genBufferedImageWithEmbeddedImg(qrCodeContent, qrCodeWidth, qrCodeHeight, embeddedImgFileFile);
        }
     ...
     * @param width             二维码的宽(px)
     * @param height            二维码的高(px)
     * @param embeddedImageFile 二维码中要嵌套的图片
     * @return 二维码图片信息BufferedImage
     * @throws IOException     IOException
     * @throws WriterException WriterException
     * @since 2019/9/9 16:39
    ...
    public static BufferedImage genBufferedImageWithEmbeddedImg(String content, int width, int height,
        ...
        BufferedImage scaleImage = scale(embeddedImageFile, embeddedImgDefaultWidth, embeddedImgDefaultHeight, false);
    ...
    private static class MatrixToImageWriter {
         ...
         */
        private static void writeToStream(BitMatrix matrix, String format, OutputStream stream, MatrixToImageConfig config) throws IOException {
            BufferedImage image = toBufferedImage(matrix, config);
         ...
         * {@link QrCodeBuilder.MatrixToImageWriter}.
         */
