...
public class OsInfo implements Serializable {
    ...
    private final String OS_VERSION = SystemUtil.getProperty("os.version", false);
    private final String OS_ARCH = SystemUtil.getProperty("os.arch", false);
    private final String OS_NAME = SystemUtil.getProperty("os.name", false);
    ...
    private final String FILE_SEPARATOR = SystemUtil.getProperty("file.separator", false);
    private final String LINE_SEPARATOR = SystemUtil.getProperty("line.separator", false);
    private final String PATH_SEPARATOR = SystemUtil.getProperty("path.separator", false);
