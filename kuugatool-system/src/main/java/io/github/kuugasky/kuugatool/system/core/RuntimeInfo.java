...
public class RuntimeInfo implements Serializable {
    ...
    public String toString() {
        ...
        SystemUtil.append(builder, "Max Memory:    ", DataSizeUtil.format(getMaxMemory()));
        SystemUtil.append(builder, "Total Memory:  ", DataSizeUtil.format(getTotalMemory()));
        SystemUtil.append(builder, "Free Memory:   ", DataSizeUtil.format(getFreeMemory()));
        SystemUtil.append(builder, "Usable Memory: ", DataSizeUtil.format(getUsableMemory()));
