...
public class JavaRuntimeInfo implements Serializable {
    ...
    private final String JAVA_RUNTIME_NAME = SystemUtil.getProperty("java.runtime.name", false);
    private final String JAVA_RUNTIME_VERSION = SystemUtil.getProperty("java.runtime.version", false);
    private final String JAVA_HOME = SystemUtil.getProperty("java.home", false);
    private final String JAVA_EXT_DIRS = SystemUtil.getProperty("java.ext.dirs", false);
    private final String JAVA_ENDORSED_DIRS = SystemUtil.getProperty("java.endorsed.dirs", false);
    private final String JAVA_CLASS_PATH = SystemUtil.getProperty("java.class.path", false);
    private final String JAVA_CLASS_VERSION = SystemUtil.getProperty("java.class.version", false);
    private final String JAVA_LIBRARY_PATH = SystemUtil.getProperty("java.library.path", false);

    private final String SUN_BOOT_CLASS_PATH = SystemUtil.getProperty("sun.boot.class.path", false);

    private final String SUN_ARCH_DATA_MODEL = SystemUtil.getProperty("sun.arch.data.model", false);
    ...
    public final String[] getClassPathArray() {
        assert getClassPath() != null;
        return getClassPath().split(Objects.requireNonNull(SystemUtil.getProperty("path.separator", false)));
    }
    ...
    public final String[] getLibraryPathArray() {
        assert getLibraryPath() != null;
        return getLibraryPath().split(Objects.requireNonNull(SystemUtil.getProperty("path.separator", false)));
    }
    ...
    public final String getProtocolPackages() {
        return SystemUtil.getProperty("java.protocol.handler.pkgs", true);
    }
